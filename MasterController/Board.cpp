#include "Board.h"
  ...
  const bool SOLVABLE1[25] = {false, true, true, true, false,
  ...
  const bool SOLVABLE2[25] = {true, false, true, false, true,
                              true, false, true, false, true,
    ...
    const bool A[25][25] = {{true, true, false, false, false, true, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false},
  ...
  const bool R[25][25] = {{false, false, false, false, false, true, false, false, false, false, true, true, false, false, false, true, false, true, false, false, false, true, true, true, false},
...
void Board::reset() {
  for (byte row = 0; row < RC; ++row) {
    INITIAL_BOARD[row] = GAME_BOARD[row] = false;
  }
}
